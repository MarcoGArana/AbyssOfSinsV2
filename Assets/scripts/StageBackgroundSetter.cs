...
{
    [Header("Asigna aqu� los sprites de cada escenario")]
    ...
    {
        // Si por alguna raz�n se entra a esta escena sin pasar por el men� (ej. probando directo desde el editor), GameManager.Instance ser� null.
